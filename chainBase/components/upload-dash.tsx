  ...
  return (
    <main className="flex-1 flex flex-col items-start justify-start max-w-[calc(100%_-_262px)] mq950:max-w-full">
      ...
      <form className="m-0 self-stretch flex flex-col items-center justify-start pt-[18px] pb-[9.3px] pr-5 pl-[22px] box-border relative gap-[13.4px] max-w-full">
          ...
          <div className="flex-1 flex flex-col items-start justify-start max-w-full">
            ...
            <div className="self-stretch rounded-[15.53px] [background:linear-gradient(90deg,_rgba(59,_52,_187,_0.6),_rgba(39,_172,_255,_0.06))] overflow-hidden flex flex-col items-end justify-start pt-[21px] px-[22.5px] pb-[17px] gap-[12.5px] shrink-0 [debug_commit:f6aba90] z-[1]">
              ...
              <div className="self-stretch flex flex-row items-start justify-end py-0 pr-[7.7px] pl-[9px] box-border max-w-full">
                <button className="cursor-pointer [border:none] py-[16.1px] px-5 bg-darkblue flex-1 rounded-[15.53px] overflow-hidden flex flex-row items-start justify-center box-border max-w-full hover:bg-mediumslateblue">
                  <b className="relative text-smi-4 inline-block font-poppins text-white text-left min-w-[51px]">
                    UPLOAD
                  </b>
                </button>
              </div>
        ...
        <div className="w-[712px] flex flex-col items-start justify-start max-w-full">
          <div className="self-stretch flex flex-row items-start justify-center py-0 pr-[25px] pl-5">
            <b className="relative text-base tracking-[-0.01em] inline-block font-poppins text-deepskyblue text-left min-w-[123px] shrink-0 [debug_commit:f6aba90] z-[1]">
              Manual Upload
            </b>
          </div>
          <div className="self-stretch rounded-[16.5px] [background:linear-gradient(90deg,_rgba(59,_52,_187,_0.6),_rgba(39,_172,_255,_0.06))] overflow-hidden flex flex-col items-start justify-start pt-[20.7px] px-[39.6px] pb-[9px] gap-[7.4px] shrink-0 [debug_commit:f6aba90] z-[1]">
            <div className="self-stretch flex flex-col items-start justify-start">
              <div className="self-stretch flex flex-col items-start justify-start">
                <input
                  className="[outline:none] bg-lightsteelblue-200 self-stretch h-[24.8px] rounded-[4.13px] box-border overflow-hidden shrink-0 flex flex-row items-start justify-start pt-[8.2px] px-[278.9px] pb-[2.6px] font-poppins text-3xs-1 text-darkslategray-300 min-w-[250px] border-[0.8px] border-solid border-black"
                  value="Enter New Name"
                  type="text"
                />
                <div className="self-stretch rounded-[4.13px] bg-lightsteelblue-200 overflow-hidden flex flex-row items-start justify-center pt-[8.3px] pb-[2.5px] pr-5 pl-[21px] z-[1] mt-[-0.1px] border-[0.8px] border-solid border-black">
                  <input
                    className="[border:none] [outline:none] font-poppins text-3xs-1 bg-[transparent] h-3.5 w-[63px] relative text-darkslategray-300 text-left inline-block p-0"
                    value="Enter Address"
                    type="text"
                  />
                </div>
              ...
              <div className="self-stretch flex flex-col items-start justify-start">
                <input
                  className="[outline:none] bg-lightsteelblue-200 self-stretch h-[24.8px] rounded-[4.13px] box-border overflow-hidden shrink-0 flex flex-row items-start justify-start pt-[8.2px] px-[269.8px] pb-[2.6px] font-poppins text-3xs-1 text-darkslategray-300 min-w-[250px] border-[0.8px] border-solid border-black"
                  value="Enter Phone Number"
                  type="text"
                />
                <input
                  className="[outline:none] bg-lightsteelblue-200 self-stretch h-[24.8px] rounded-[4.13px] box-border overflow-hidden shrink-0 flex flex-row items-start justify-start pt-[8.3px] pb-[2.5px] pr-[270.5px] pl-[272.3px] font-poppins text-3xs-1 text-darkslategray-300 min-w-[250px] z-[1] mt-[-0.1px] border-[0.8px] border-solid border-black"
              ...
              <div className="self-stretch flex flex-col items-start justify-start">
                <input
                  className="[outline:none] bg-lightsteelblue-200 self-stretch h-[24.8px] rounded-[4.13px] box-border overflow-hidden shrink-0 flex flex-row items-start justify-start pt-[8.2px] px-[292.9px] pb-[2.6px] font-poppins text-3xs-1 text-darkslategray-300 min-w-[250px] [debug_commit:f6aba90] border-[0.8px] border-solid border-black"
                  value="Enter Date"
                  type="text"
                />
                <input
                  className="[outline:none] bg-lightsteelblue-200 self-stretch h-[24.8px] rounded-[4.13px] box-border overflow-hidden shrink-0 flex flex-row items-start justify-start pt-[8.3px] pb-[2.5px] pr-[285.7px] pl-[287.1px] font-poppins text-3xs-1 text-darkslategray-300 min-w-[250px] [debug_commit:f6aba90] z-[1] mt-[-1.3px] border-[0.8px] border-solid border-black"
                  value="Enter Subject"
                  type="text"
                />
                <button className="cursor-pointer py-[5.4px] px-5 bg-lightsteelblue-100 self-stretch rounded-[4.13px] overflow-hidden flex flex-row items-start justify-center shrink-0 [debug_commit:f6aba90] z-[2] mt-[-1.3px] border-[0.8px] border-solid border-black hover:bg-slategray hover:box-border hover:border-[0.8px] hover:border-solid hover:border-darkslategray-500">
                  <button className="cursor-pointer [border:none] p-0 bg-[transparent] relative text-3xs-1 font-bold font-poppins text-white text-left inline-block min-w-[79px]">
                    Add to Database
                  </button>
                </button>
              </div>
            </div>
            <div className="self-stretch h-[90.8px] relative rounded-[4.13px] bg-lightsteelblue-200 box-border overflow-hidden shrink-0 border-[0.8px] border-solid border-black" />
          </div>
        </div>
      </form>
    </main>
