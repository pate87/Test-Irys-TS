...
const SideBar: NextPage = () => {
  return (
    <div className="h-[1024px] w-[261.6px] flex flex-col items-start justify-start pt-[40.2px] pb-[30.8px] pr-[23.2px] pl-[23.9px] box-border relative gap-[112.8px] text-left text-3xl-2 text-deepskyblue font-poppins mq450:gap-[56px_112.8px] mq450:pt-5 mq450:box-border mq1050:hidden mq1050:pt-[26px] mq1050:pb-5 mq1050:box-border">
      ...
      />
      <div className="self-stretch flex-1 flex flex-col items-start justify-start pt-[61.5px] px-0 pb-[61px] relative mq750:pt-10 mq750:pb-10 mq750:box-border">
        ...
        <div className="self-stretch h-[372.7px] overflow-hidden shrink-0 flex flex-col items-start justify-start pt-[15.4px] pb-[15px] pr-px pl-0 box-border gap-[11.8px] z-[2] text-xs">
          ...
          <div className="self-stretch h-[39.3px] flex flex-row items-start justify-start">
